...
public class CustomString {
    ...
    public String getString() {
        ...
        String result=null;
        if(this.isSet&&this.myString!=null)
    ...
    public String remove(String arg) {
        // TODO Implement method
        if(this.myString==null||this.isSet==false||"".equals(this.myString))
            return "";
        StringBuilder stringBuilder=new StringBuilder();
        for(int i=0;i<this.myString.length();i++){
            if(((this.myString.charAt(i)>='a'&&this.myString.charAt(i)<='z')||(this.myString.charAt(i)>='A'&&this.myString.charAt(i)<='Z'))){
                char newChar;
                if(this.myString.charAt(i)>='a'&&this.myString.charAt(i)<='z')
                    newChar=(char)(this.myString.charAt(i)-32);
                else
                    newChar=(char)(this.myString.charAt(i)+32);
                if(!(arg.contains(this.myString.charAt(i)+"")||arg.contains(newChar+"")))
                stringBuilder.append(this.myString.charAt(i));
            }else {
                stringBuilder.append(this.myString.charAt(i));
            }
        }
    ...
    public String reverse(String arg) {
        ...
        if(this.myString==null||this.isSet==false||"".equals(this.myString))
            return "";
        StringBuilder stringBuilder=new StringBuilder(this.myString);
        for(int i=0;i<stringBuilder.length();i++){
            char ch;
            if(this.myString.charAt(i)>='a'&&this.myString.charAt(i)<='z')
                ch=(char)(this.myString.charAt(i)-32);
            else
                ch=(char)(this.myString.charAt(i)+32);
           if(arg.contains(stringBuilder.charAt(i)+"")||arg.contains(ch+"")) {
               if(stringBuilder.charAt(i)>='a'&&stringBuilder.charAt(i)<='z'){
                   char newChar=(char)(stringBuilder.charAt(i)-32);
    ...
    public String filterLetters(char n, boolean more) {
        // TODO Implement method
        if(this.myString==null||!((n>='a'&&n<='z')||(n>='A'&&n<='Z')))
            return "";
        StringBuilder stringBuilder=new StringBuilder();
        for(int i=0;i<this.myString.length();i++){
            if(!((this.myString.charAt(i)>='a'&&this.myString.charAt(i)<='z')||(this.myString.charAt(i)>='A'&&this.myString.charAt(i)<='Z'))) {
           ...
           if(more){
                if((n+"").compareToIgnoreCase(this.myString.charAt(i)+"")>0)
                    stringBuilder.append(this.myString.charAt(i));
           }else {
               if((n+"").compareToIgnoreCase(this.myString.charAt(i)+"")<0)
                   stringBuilder.append(this.myString.charAt(i));
    ...
    public static void main(String[] args) {
        ...
        string.setString("Hello 90, bye 2");
        System.out.println(string.filterLetters('h',false));
    }
}