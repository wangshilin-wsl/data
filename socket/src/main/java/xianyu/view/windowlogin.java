...
import xianyu.controller.HandleAdd;
import xianyu.controller.HandleLogin;
...
public class windowlogin extends JFrame {
	...
	void setListener(){
		...
		//数字按键与HandleDigit监听器对象的捆绑
		HandleAdd Handleadd = new HandleAdd(this);
		button_2.addActionListener(Handleadd);//添加
